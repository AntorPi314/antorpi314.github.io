 ...
 *
 * The card box itself never disappears during a Thanos snap — only
 * everything inside it (header, description, tech badges) is wrapped
 * in a single ThanosPart, so the empty card shell keeps its exact
 * size/layout in the grid while its contents fade to fully
 * transparent (and back), instead of any dust/particle animation.
 */
function ProjectCard({
  ...
  return (
    ...
    >
      <ThanosPart sectionId="projects" partId={id} partsRef={partsRef} className="flex flex-col flex-1">
